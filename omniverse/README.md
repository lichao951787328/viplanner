...
To install the ViPlanner extension for Isaac Sim version **5.0.0**, follow these steps:
...
1. Clone the [IsaacLab](https://github.com/isaac-sim/IsaacLab) repo.
    ...
    **IMPORTANT**: The extension is tested with IsaacSim 5.0.0 and IsaacLab 2.0.0+. If you encounter issues with newer versions, please report them via GitHub issues. Any PRs with updated compatibility are welcome.
